...
//	Timer 时间类
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		// 常用方法
		// indexOf()正数从某位开始（默认是0）出现指定目标的下标
		...
		System.out.println(str.indexOf(65600));// 100表示ascii中对应的值
		System.out.println(str.indexOf(100, 2));
		// lastIndexOf()倒数从某位开始（默认是0）出现指定目标的下标
		...
		// toCharArray()获得一个字符数组
		System.out.println(Arrays.toString(str.toCharArray()));
		// concat(String)连接两个子串
		String str1 = "33";
		String str2 = "44";
		String str3 = "3344";
		...
		buffer.append("sd");
		buffer.append('3');
		// delete(int,int) 删除多个连续的字符
		System.out.println(buffer.delete(0, 2));
		// deleteCharAt(int) 删除单个字符
